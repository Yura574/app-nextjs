...
import {PurchasesType, WarehousePurchasesTC} from "../../../../store/reducers/purchases-reducer";
...
export const Warehouse = () => {
    ...
    const {id} = useParams()
    const purchases = useAppSelector<PurchasesType[]>(state => state.purchases.purchases)
